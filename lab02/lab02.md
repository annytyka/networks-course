...
#### Решение
У первого канала самая низкая скорость передачи, поэтому после его прохождения задержки не будет. $\dfrac{5000 * 8}{200} = 200$ секунд. Последний пакет размера $N$ Кбит пройдёт по оставшимся каналам за $\dfrac{N}{3000} + \dfrac{N}{3000}$ секунд, поэтому итоговое время равно $200 + \dfrac{N}{3000} + \dfrac{N}{3000}$ секунд.
