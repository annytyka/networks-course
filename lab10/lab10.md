<img width="1920" height="882" alt="изображение" src="https://github.com/user-attachments/assets/eef21362-fdc9-4e25-b11f-fc6745c4c8e1" /># Практика 10. Сетевой уровень
...
<img width="1920" height="547" alt="изображение" src="https://github.com/user-attachments/assets/706fd744-1233-4303-a2f5-be7b44d5770f" />
...
<img width="1920" height="558" alt="изображение" src="https://github.com/user-attachments/assets/1587d7f9-9b7e-42e3-ac7c-3ace0c7d495a" />

<img width="1919" height="553" alt="изображение" src="https://github.com/user-attachments/assets/bc0d5d90-8de5-45e2-8bf8-d6c07b71bbca" />
   ...
   2. Какие поля не меняются? Какие поля должны оставаться неизменными? Какие
      ...
      - Version, Header Length, Total Length, Source Address, Destination Address, Protocol
      - Version, Header Length, Total Length, Source Address, Destination Address, Protocol
      - Identification, Time to Live, Header Checksum
   3. Как изменяется значение поля Identification IP-дейтаграммы с каждым
      ...
      - Увеличивается
      - На 1 каждый раз
4. Какое значение содержится в поле Identification (Идентификация), а какое – в поле TTL
   (выберите какой-либо один пакет ICMP)?
   - Identification: 0x0ea3
   - TTL: 64
5. Остаются ли эти значения (Identification и TTL) неизменными во всех сообщениях
   ...
   - TTL сохраняется, Identification меняется
6. Найдите серии откликов ICMP, в которых содержатся сообщения об истечении
...
<img width="1920" height="550" alt="изображение" src="https://github.com/user-attachments/assets/9a7c07d8-ab6e-4677-a17c-ab87826424e3" />

7. **Фрагментация**. Остановите захват пакетов в Wireshark. Измените размер пакета
